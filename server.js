...
app.get("/health",(_req,res)=>res.status(200).json({ok:true,service:"scan-ar",version:"3.6.0",time:new Date().toISOString()}));
...
const server=app.listen(port,"0.0.0.0",()=>console.log(`My AR Shelf v3.6.0 listening on ${port}`));
